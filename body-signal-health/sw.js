const CACHE='bodysignal-v36';
const ASSETS=['./','./index.html','./app.js','./manifest.webmanifest','./vendor/chart.umd.min.js','./icons/logo.svg','./icons/icon-192.png','./icons/icon-512.png'];
